...
seq(1,10, by=0.5)  # seq dari 1 - 10, jaraknya 0.2
...
#write data/eksport data
library('datasets')
data('Orange')
getwd()
setwd("C:/Users/Nazia Mahmudah/Downloads/SEMESTER 5/NGASDOS KOMSTAT 2023/Week 1")
...
library(haven)
write_sav(Orange,"C:/Users/Nazia Mahmudah/Downloads/SEMESTER 5/NGASDOS KOMSTAT 2023/Week 1/orange1.sav")

##IMPORT DATA
setwd("C:/Users/Nazia Mahmudah/Downloads/SEMESTER 5/NGASDOS KOMSTAT 2023/Week 1")
list.files()
#read txt
orange1 <- read.csv("C:/Users/Nazia Mahmudah/Downloads/SEMESTER 5/NGASDOS KOMSTAT 2023/Week 1/orange1.txt", sep="")
orange1
#read excel
library(readxl)
data_xl = read_excel("C:/Users/Nazia Mahmudah/Downloads/SEMESTER 5/NGASDOS KOMSTAT 2023/Week 1/data_tinggi.xlsx")
...
#read_sav
library(foreign)
data_sav = read.spss("orange1.sav", use.value.labels=TRUE, to.data.frame=TRUE)
